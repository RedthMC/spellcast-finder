...
* @returns {boolean}
*/
export function load_word_list(word_list) {
    const ptr0 = passStringToWasm0(word_list, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.load_word_list(ptr0, len0);
    return ret !== 0;
}
...
export class JsSearchResult {
    ...
    free() {
        ...
        wasm.__wbg_jssearchresult_free(ptr);
    }
    /**
    * @returns {number}
    */
    get score() {
        const ret = wasm.__wbg_get_jssearchresult_score(this.__wbg_ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set score(arg0) {
        wasm.__wbg_set_jssearchresult_score(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {Int32Array}
    */
    get path() {
        try {
            ...
            wasm.jssearchresult_path(retptr, this.__wbg_ptr);
    ...
    */
    get word() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jssearchresult_word(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('spellcast_finder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
